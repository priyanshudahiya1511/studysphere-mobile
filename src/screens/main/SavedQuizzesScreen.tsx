...
import { ArrowLeft, HelpCircle, Trash2 } from 'lucide-react-native';
...
export default function SavedQuizzesScreen() {
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <Pressable
                onPress={() =>
                  navigation.navigate('Quiz', { quizId: item._id })
                }
